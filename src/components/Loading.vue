<template>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="50px" height="50px">
            ...
            <circle transform-origin="center" fill="none" stroke="url(#a12)" stroke-width="15" stroke-linecap="round"
                ...
                <animateTransform type="rotate" attributeName="transform" calcMode="spline" dur="0.3" values="360;0"
