<template>
    <div>
        <button v-if="!account" @click="connectWallet" class="button1 kananatas"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div v-else>
            <button @click="closeAndShowPlay" class="button1 kananatas"><svg xmlns="http://www.w3.org/2000/svg"
                    id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="25" height="25" fill="#570eaa">
                    <path
            ...
            <button class="button1 account">{{ account.slice(0,4) }}...{{ account.slice(-4) }}</button>
        </div>
    </div>
</template>

<script setup>
import { account, connectWallet, disconnectWallet, autoConnect } from "../utils/web3connect";
